...
public class SharedPreferenceUtils {
    ...
    private static final Logger LOG         = Logger.getLogger(SharedPreferenceUtils.class);

    /**
     * 为了版本兼容， 这个不能修改!
     */
    public static final String  NAME_PREFIX = "shared_sp";
     ...
     * @param pSPMode
     *            SharedPreference 的可读写权限范围 {@link Context.MODE_MULTI_PROCESS},
    ...
    public static SharedPreferences getSharedPreferences(Context pContext, String pPrefsName, int pSPMode) {
        ...
        // getSharedPreferencesEditor(pContext, pPrefsName)
    ...
    //
    // public static void setStringSet(Context pContext, String pKey,Set<String>
    // pValues){
    // SharedPreferences.Editor editor = getSharedPreferencesEditor(pContext);
    // setStringSet(editor, pKey, pValues);
    // }
    //
    // public static Set<String> getStringSet(Context pContext,String
    // pKey,Set<String> pDefaultSet){
    // SharedPreferences preferences = getSharedPreferences(pContext);
    // return preferences.getStringSet(pKey, pDefaultSet);
    // }
    //
    // public static void setStringSet(Editor pEditor, String pKey,Set<String>
    // pValues){
